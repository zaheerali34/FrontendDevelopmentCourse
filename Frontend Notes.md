# 6 Months Course Frontend Development
...
- `Using Keyframes`
- `Drag Animations`
- `Hover And Top Animations`
- `Staggering Animations`
- `Sequencing Animations`
- `Scroll animations ('useScroll', Parallax, Effects`)
- `Animating Layout`
- `Using ('AnimatePersence')`
- `Creating Custom animation Hook`
...
### Episode 11 - Frontend Interviews
- `HTML`
- `CSS`
- `JavaScript`
- `React Js`
